...
// Then, I could edit the console.log statement to interpolate the 'avgAge' variable that would invoke the function and interpolate the printed value within a string.